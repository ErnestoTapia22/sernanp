...
public class AgreementStateModel {
	...
	@Column (name= "srl_id")
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator="t_estado_acuerdo_srl_id_seq")
	@SequenceGenerator(name="t_estado_acuerdo_srl_id_seq", sequenceName="t_estado_acuerdo_srl_id_seq", allocationSize=1)
	private int id;
